...
int main(int argc, char** argv)
{
        ...
        while (1) {
                ...
                double posX   = outSizeReportedX / 2;
                double posY   = outSizeReportedY / 2;

                for (size_t y = 0; y < outSizeReportedX; y++)
                for (size_t x = 0; x < outSizeReportedY; x++)
                {
